...
hl.animation({ leaf = "specialWorkspaceIn",  enabled = true, speed = 2, bezier = "default", style = "slidevert" })
hl.animation({ leaf = "specialWorkspaceOut", enabled = true, speed = 2, bezier = "default", style = "slidevert" })
